...
class BellmanFordNavigatorCat(Globals):
    @staticmethod
    def getBestDirection(target):

        currentCatDist = Globals.rc.getLocation().distanceSquaredTo(Globals.catLoc)
        ...
        distance1 = 1000000
        direction1 = None
        newDist1 = location1.distanceSquaredTo(Globals.catLoc)
        weight1 = ((3 if Vision.isDirt(location1) else 1) + (0 if currentCatDist < newDist1 else (2 if currentCatDist == newDist1 else 4))) if canVisit1 else 1000000
        distance2 = 1000000
        direction2 = None
        newDist2 = location2.distanceSquaredTo(Globals.catLoc)
        weight2 = ((3 if Vision.isDirt(location2) else 1) + (0 if currentCatDist < newDist2 else (2 if currentCatDist == newDist2 else 4))) if canVisit2 else 1000000
        distance3 = 1000000
        direction3 = None
        newDist3 = location3.distanceSquaredTo(Globals.catLoc)
        weight3 = ((3 if Vision.isDirt(location3) else 1) + (0 if currentCatDist < newDist3 else (2 if currentCatDist == newDist3 else 4))) if canVisit3 else 1000000
        distance4 = 1000000
        direction4 = None
        newDist4 = location4.distanceSquaredTo(Globals.catLoc)
        weight4 = ((3 if Vision.isDirt(location4) else 1) + (0 if currentCatDist < newDist4 else (2 if currentCatDist == newDist4 else 4))) if canVisit4 else 1000000
        distance5 = 1000000
        direction5 = None
        newDist5 = location5.distanceSquaredTo(Globals.catLoc)
        weight5 = ((3 if Vision.isDirt(location5) else 1) + (0 if currentCatDist < newDist5 else (2 if currentCatDist == newDist5 else 4))) if canVisit5 else 1000000
        distance6 = 1000000
        direction6 = None
        newDist6 = location6.distanceSquaredTo(Globals.catLoc)
        weight6 = ((3 if Vision.isDirt(location6) else 1) + (0 if currentCatDist < newDist6 else (2 if currentCatDist == newDist6 else 4))) if canVisit6 else 1000000
        distance7 = 1000000
        direction7 = None
        newDist7 = location7.distanceSquaredTo(Globals.catLoc)
        weight7 = ((3 if Vision.isDirt(location7) else 1) + (0 if currentCatDist < newDist7 else (2 if currentCatDist == newDist7 else 4))) if canVisit7 else 1000000
        distance8 = 1000000
        direction8 = None
        newDist8 = location8.distanceSquaredTo(Globals.catLoc)
        weight8 = ((3 if Vision.isDirt(location8) else 1) + (0 if currentCatDist < newDist8 else (2 if currentCatDist == newDist8 else 4))) if canVisit8 else 1000000
        distance9 = 1000000
        direction9 = None
