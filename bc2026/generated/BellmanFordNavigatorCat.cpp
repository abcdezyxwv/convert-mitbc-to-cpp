#include "BellmanFordNavigatorCat.hpp"
#include "../api.hpp"
...
Direction BellmanFordNavigatorCat::getBestDirection(MapLocation target) {

    int currentCatDist = rc.getLocation().distanceSquaredTo(catLoc);
...
int newDist1 = location1.distanceSquaredTo(catLoc);
        int weight1 = canVisit1 ? (Vision::isDirt(location1) ? 3 : 1) + (currentCatDist < newDist1 ? 0 : (currentCatDist == newDist1 ? 2 : 4)) : 1000000;
        int distance2 = 1000000;
        Direction direction2 = NULL_DIRECTION;
int newDist2 = location2.distanceSquaredTo(catLoc);
        int weight2 = canVisit2 ? (Vision::isDirt(location2) ? 3 : 1) + (currentCatDist < newDist2 ? 0 : (currentCatDist == newDist2 ? 2 : 4)) : 1000000;
        int distance3 = 1000000;
        Direction direction3 = NULL_DIRECTION;
int newDist3 = location3.distanceSquaredTo(catLoc);
        int weight3 = canVisit3 ? (Vision::isDirt(location3) ? 3 : 1) + (currentCatDist < newDist3 ? 0 : (currentCatDist == newDist3 ? 2 : 4)) : 1000000;
        int distance4 = 1000000;
        Direction direction4 = NULL_DIRECTION;
int newDist4 = location4.distanceSquaredTo(catLoc);
        int weight4 = canVisit4 ? (Vision::isDirt(location4) ? 3 : 1) + (currentCatDist < newDist4 ? 0 : (currentCatDist == newDist4 ? 2 : 4)) : 1000000;
        int distance5 = 1000000;
        Direction direction5 = NULL_DIRECTION;
int newDist5 = location5.distanceSquaredTo(catLoc);
        int weight5 = canVisit5 ? (Vision::isDirt(location5) ? 3 : 1) + (currentCatDist < newDist5 ? 0 : (currentCatDist == newDist5 ? 2 : 4)) : 1000000;
        int distance6 = 1000000;
        Direction direction6 = NULL_DIRECTION;
int newDist6 = location6.distanceSquaredTo(catLoc);
        int weight6 = canVisit6 ? (Vision::isDirt(location6) ? 3 : 1) + (currentCatDist < newDist6 ? 0 : (currentCatDist == newDist6 ? 2 : 4)) : 1000000;
        int distance7 = 1000000;
        Direction direction7 = NULL_DIRECTION;
int newDist7 = location7.distanceSquaredTo(catLoc);
        int weight7 = canVisit7 ? (Vision::isDirt(location7) ? 3 : 1) + (currentCatDist < newDist7 ? 0 : (currentCatDist == newDist7 ? 2 : 4)) : 1000000;
        int distance8 = 1000000;
        Direction direction8 = NULL_DIRECTION;
int newDist8 = location8.distanceSquaredTo(catLoc);
        int weight8 = canVisit8 ? (Vision::isDirt(location8) ? 3 : 1) + (currentCatDist < newDist8 ? 0 : (currentCatDist == newDist8 ? 2 : 4)) : 1000000;
